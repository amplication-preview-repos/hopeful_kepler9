...
@InputType()
class CollaborationInvitationUpdateManyWithoutProjectsInput {
...
export { CollaborationInvitationUpdateManyWithoutProjectsInput as CollaborationInvitationUpdateManyWithoutProjectsInput };
