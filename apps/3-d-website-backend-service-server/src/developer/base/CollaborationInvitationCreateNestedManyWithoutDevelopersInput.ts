...
@InputType()
class CollaborationInvitationCreateNestedManyWithoutDevelopersInput {
...
export { CollaborationInvitationCreateNestedManyWithoutDevelopersInput as CollaborationInvitationCreateNestedManyWithoutDevelopersInput };
